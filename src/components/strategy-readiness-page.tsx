      ...
      <section className="section-shell pt-36 pb-16 md:pt-44 md:pb-24">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_24rem] lg:items-end">
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="mt-6 max-w-4xl text-balance text-5xl font-semibold leading-[0.9] tracking-[-0.08em] text-white md:text-7xl xl:text-[6.4rem]">Build the right AI strategy before you build AI products.</h1>
