...
const strategyStages = [
  {
    ...
    detail: "Map enterprise opportunities, run use-case workshops, and assess AI maturity.",
    color: "#8b5cf6"
  },
  {
    number: "02",
    title: "ROI & Business Case",
    detail: "Model value, simulate costs, and prioritize the right AI investments.",
    color: "#a855f7"
  },
  {
    number: "03",
  ...
  },
  {
    ...
    detail: "Make ethics, regulation, responsible AI, risk, and bias part of the plan.",
    color: "#0ea5e9"
  },
  {
    number: "05",
